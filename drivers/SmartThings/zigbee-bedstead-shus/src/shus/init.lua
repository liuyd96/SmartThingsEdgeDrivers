...
local FINGERPRINTS = {
  { mfr = "SHUS", model = "shus.smart.bedstead" }
}
...
--[[
 movement_control_back_cap_handler(driver, device, { args = { backControl = "down" } })
  movement_control_leg_cap_handler(driver, device, { args = { legControl = "down" } })
  movement_control_back_leg_cap_handler(driver, device, { args = { backLegControl = "down" } })
  massage_control_state_cap_handler(driver, device, { args = { stateControl = "off" } })
  massage_control_back_strength_cap_handler(driver, device, { args = { backStrengthControl = 0 } })
  massage_control_leg_strength_cap_handler(driver, device, { args = { legStrengthControl = 0 } })
  massage_control_frequency_cap_handler(driver, device, { args = { frequencyControl = 1 } })
  mode_cap_handler(driver, device, { args = { stateControl = "stop" } })
  night_light_cap_handler(driver, device, { args = { stateControl = "off" } })
  --]]
